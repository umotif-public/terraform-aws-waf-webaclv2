        ...
        dynamic "ip_set_reference_statement" {
          ...
          content {
            ...
            dynamic "ip_set_forwarded_ip_config" {
              for_each = length(lookup(ip_set_forwarded_ip_config.value, "ip_set_forwarded_ip_config", {})) == 0 ? [] : [lookup(ip_set_forwarded_ip_config.value, "ip_set_forwarded_ip_config ", {})]
              content {
